 ...
 */
export function vecnoToVeni(vecno) {
 ...
 * @returns {string}
 */
export function veniToVecnoString(veni) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {string}
 */
export function veniToVecnoStringWithSuffix(veni, network) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper17454 = function(arg0, arg1, arg2) {
    ...
    imports.wbg.__wbindgen_closure_wrapper7218 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 1875, __wbg_adapter_75);
        return addHeapObject(ret);
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('vecno_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
