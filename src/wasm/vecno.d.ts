...
export interface InitOutput {
  ...
  readonly vecnoToVeni: (a: number, b: number) => number;
  readonly veniToVecnoString: (a: number, b: number) => void;
  readonly veniToVecnoStringWithSuffix: (a: number, b: number, c: number) => void;
